 ...
 * Requires Lumination Core (v1.1.0+) for API access and analytics.
 *
...
define( 'LUMINATION_QG_VERSION', '1.1.0' );
...
add_action(
	...
	function () {
		$core_ok = function_exists( 'lumination_core' )
				...
				&& version_compare( LUMINATION_CORE_VERSION, '1.1.0', '>=' );
				...
				function () {
					...
					$msg = sprintf(
						wp_kses(
							...
							__( '<strong>Lumination AI Quiz Generator</strong> requires <strong>Lumination Core</strong> (v1.1.0+) to be installed and active. <a href="%s">Manage plugins &rarr;</a>', 'lumination-quiz-generator' ),
							array(
								'strong' => array(),
								'a'      => array( 'href' => array() ),
							)
